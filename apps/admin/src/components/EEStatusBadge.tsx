/**
 * EEStatusBadge -- maps MedicaidEeCaseStatus enum values to styled badges
...
export interface EEStatusBadgeProps {
  status: EECaseStatus;
  className?: string;
}

export function EEStatusBadge({ status, className }: EEStatusBadgeProps) {
